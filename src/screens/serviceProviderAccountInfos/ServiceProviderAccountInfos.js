...
import styles from '../serviceProviderAccountInfos/styles';

const ServiceProviderAccountInfos = () => {
    ...
    const [tempAccData, setTempAccData] = useState({
        name: 'Adam',
        surname: 'Sound',
        email: 'adamsound@gmail.com',
        phoneNum: '+905554537688',
        city: null,
        district: null,
        neighborhood: null,
    });
...
export default ServiceProviderAccountInfos;
