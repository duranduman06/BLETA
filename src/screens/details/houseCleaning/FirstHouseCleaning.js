...
const FirstHouseCleaning = () => {
  ...
  return (
    <SafeAreaView>
      <Text style={{ alignSelf: 'center' }}>House Cleaning</Text>
      <View style={{ width: PhoneWidth * 0.2, height: 2.5, backgroundColor: 'purple', marginTop: 5 }}></View>
      <View style={styles.timePriceBox}>
        <Text>4 Hours per week</Text>
        <Text>$ 200</Text>
      </View>
      <View style={styles.bottomBigBox}>
        <Text style={styles.titleBig}>How Big Your House?</Text>
        <Text style={styles.description}>We clean and organize the house in detail. Within the scope of our services, cleaning the floor and windows, dusting, emptying the garbage and kitchen cleaning using the materials at home.</Text>
        <FlatList
          data={buttonData}
