    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.imageBox}>
                <Image
                    style={styles.image}
                    source={require('../../../assets/services/sofamoving.jpg')}
                />
            </View>
            <View style={styles.bottomBox}>
                <View style={styles.infoBox}>
                    <Text style={styles.title}>Sofa Moving</Text>
                    ...
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>158.100 people a year trust Bleta for sofa moving</Text>
                    <View style={styles.line}></View>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('firstSofaMoving')}
