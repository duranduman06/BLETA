    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.imageBox}>
                <Image
                    style={styles.image}
                    source={require('../../../assets/services/fridgemoving.jpg')}
                />
            </View>
            <View style={styles.bottomBox}>
                <View style={styles.infoBox}>
                    <Text style={styles.title}>Fridge Moving</Text>
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>7.148 moving crew are ready!</Text>
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>4.5 avg. stars (347.579 approved comments)</Text>
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>158.100 people a year trust Bleta for fridge moving</Text>
                    <View style={styles.line}></View>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('firstFridgeMoving')}
