        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.bottomBox}>
                <View style={styles.infoBox}>
                    <Text style={styles.title}>Intercity Moving</Text>
                    ...
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>20.100 people a year trust Bleta for intercity moving</Text>
                    <View style={styles.line}></View>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('firstIntercityMoving')}
