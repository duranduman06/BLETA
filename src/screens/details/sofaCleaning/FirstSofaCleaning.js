...
const FirstSofaCleaning = () => {
  ...
  return (
    <SafeAreaView>
      <Text style={{ alignSelf: 'center', fontFamily: 'PJMasks-Bold' }}>Sofa Cleaning</Text>
      ...
      <View style={styles.bottomBigBox}>
        <Text style={styles.titleBig}>How many sofas or armchairs do you need to clean?</Text>
        <Text style={styles.description}>
          Our sofa cleaning service ensures your furniture is thoroughly cleaned and refreshed. Please select the number of sofas or armchairs you need to clean.
        </Text>
        <FlatList
          data={buttonData}
...
export default FirstSofaCleaning;
