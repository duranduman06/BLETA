    ...
    return (
        <SafeAreaView style={styles.container}>
            <View style={styles.imageBox}>
                <Image
                    style={styles.image}
                    source={require('../../../assets/services/sofacleaning.jpg')}
                />
            </View>
            <View style={styles.bottomBox}>
                <View style={styles.infoBox}>
                    <Text style={styles.title}>Sofa Cleaning</Text>
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>7.148 sofa cleaners are ready!</Text>
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>4.5 avg. stars (347.579 approved comments)</Text>
                    <View style={styles.line}></View>
                    <Text style={styles.detailTxt}>158.100 people a year trust Bleta for sofa cleaning</Text>
                    <View style={styles.line}></View>
                </View>
                ...
                <View style={styles.buttonContainer}>
                    <TouchableOpacity
                        onPress={() => navigation.navigate('firstSofaCleaning')}
